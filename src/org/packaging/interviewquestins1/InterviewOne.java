...
public class InterviewOne {
	...
	private static void  perFormingSummation(TreeSet<Integer> collectionsOfSum, int index, int nums[], int sum, int count) {

		if (count == 3) {
			collectionsOfSum.add(sum);
			return;
		}
		...
		for (int i = index; i < nums.length; i++)
			perFormingSummation(collectionsOfSum, i + 1, nums, sum + nums[i], count + 1);
